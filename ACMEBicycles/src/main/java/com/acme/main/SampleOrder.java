...
public class SampleOrder {
    ...
    private final InventoryGenertator inventory;
    ...
    public SampleOrder() {
        ...
        inventory = new InventoryGenertator();
    }
    ...
    private void buyBike() {
        System.out.println("What kind of bike would your like?");
        System.out.println("Your options are:\nc - Cross Country\n" +
                "d - DownHill\nt - Touring\nv - Vintage");
        String type = userIn.next();
    ...
    public void frameColorOffer(AbstractBike bike) {
