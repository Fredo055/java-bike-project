...
import com.acme.controller.InventoryGenertator;
...
public class Main {
    ...
    private static void testReceipt() {
        ...
        InventoryGenertator gen = new InventoryGenertator();
    ...
    private static void testingSerialNumbers() {
        ...
        myGen.startGeneration(oldBike.getPrefix(), oldBike.getStartNumber());
    ...
    private static void testCustomsOptions() {
       ...
       double bikePrice = option1.getPrice().add(option1.getOptionAmount()).doubleValue();
        System.out.println(bikePrice);
        GoldFrameOption option2 = new GoldFrameOption(option1);
        System.out.println(option2.getOptionAmount());
