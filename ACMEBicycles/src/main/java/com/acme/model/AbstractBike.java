...
public abstract class AbstractBike implements
   ...
   public abstract BigDecimal getOptionAmount();
    ...
    public String airTires() {
        String airMessage = "We are our bike tires to a consistent 32 psi.";
        String testTire = "We test each tire prior to sale for proper air pressure.";
    ...
    public String assembleAndTestRide() {
        String assemble = "We assemble out bikes using proper torque ratings for your safety.";
